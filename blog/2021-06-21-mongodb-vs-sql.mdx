...
[Nova](https://github.com/kaviarjs/nova) is a3 Node MongoDB driver extension which enables collection linking and fetching data relationally. It brings beautiful developer experience when fetching relational data.
