...
<PackageHeader version="1.0.7" packageName="x-password-bundle" containsTypeDefs />

This package from X-Framework gives you fully integrated passwords system, with GraphQL endpoints and customisable emails.
